...
$(document).ready(function() {
	...
	$('.cycle').each(function() {
    var slideshow = $(this);
    var currslideholder = $(this).parent().find('.curr-slide-num');
    ...
    slideshow.cycle({
        ...
        after: function (curr, next, opts) {
        	$(this).parent().parent().find('.curr-slide-num').html((opts.currSlide+1));
    		//console.log("Current slide " + (opts.currSlide+1));
		}
    });
});
